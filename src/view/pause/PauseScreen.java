...
public class PauseScreen extends JDialog implements IPause, MouseListener, Observer {
	...
	public void update(Observable o, Object arg) {
		if (o instanceof Translation) {
			...
			this.setTitle(tran.getPauseName());
			title.setText(tran.getPauseName());
			if (resume != null && highScore != null && restart != null && tutorial != null && setting != null
					&& language != null && home != null && exit != null) {
				resume.setText(tran.getResumeName());
				highScore.setText(tran.getHighScoreName());
				restart.setText(tran.getRestartName());
				tutorial.setText(tran.getTutorialName());
				setting.setText(tran.getSettingName());
				language.setText(tran.getLanguageName());
